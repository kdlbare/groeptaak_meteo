...
ggplot(data=radiation_cycles) +
  geom_point(mapping = aes(date, mean_RN, colour = 'yellow')) +
  geom_point(mapping = aes(date, mean_QH, colour = 'red')) +
  geom_point(mapping = aes(date, mean_QLE, colour = 'blue')) +
  geom_point(mapping = aes(date, mean_GF, colour = 'brown'))
```
