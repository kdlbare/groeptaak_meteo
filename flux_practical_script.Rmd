...
geom_vline(xintercept=c(80,172,264,355))+
  ...
  scale_color_manual(values=c('darkgreen','blue','green', 'red', 'orange', 'black', 'brown',
                     ...
                     labels = c('LW down (daW/m²)', 'regen (mm/dag)', 'SW down (daW/m²)', 'T (°C)',
                                ...
                                'wind (m/s)'))+
  annotate("text", x=30, y=40, label = "zomer")+
  annotate("text", x=110, y=40, label = "herfst")+
  annotate("text", x=202, y=40, label = "winter")+
  annotate("text", x=294, y=40, label = "lente")
...
regen <- ggplot(average_rain_per_month, aes(x=MONTH, y=rain))+
  ...
  scale_x_discrete(limits=1:12,
                   name = 'Maand')+
  scale_y_discrete(name='gemiddelde regenval (mm)',
