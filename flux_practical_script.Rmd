...
geom_vline(xintercept=c(80,172,264,355))+
  labs(title = "Meteorological Variables Across Days of the Year",
       x = "Day of the Year",
       y = "Average Value") +
  scale_color_manual(values=c('darkgreen','blue','#FF00CC', 'red', 'orange', 'black', 'brown', 'purple','green'), 
                     labels = c('LW down (hW/m²)', 'rain (mm/dag)', 'SW down (hW/m²)', 'T (°C)',
